...
class Gantt {
    ...
    setup_gantt_dates() {
        ...
        } else if (this.view_is('Month') || this.view_is('Quarter')) {
    ...
    make_grid_ticks() {
        ...
        for (let date of this.dates) {
            ...
            if (this.view_is('Month') || this.view_is('Quarter')) {
                tick_x +=
    ...
    get_date_info(date, last_date, i) {
        ...
        const date_text = {
            ...
            Quarter_lower: date_utils.format(
                date,
                'MMMM',
                this.options.language
            ),
        ...
        const base_pos = {
            ...
            lower_y:
                ...
                (this.options.font_size * 3) / 2,
            upper_y: (this.options.header_height - this.options.font_size) / 2,
        };
        ...
        const x_pos = {
            ...
            Quarter_upper: this.options.column_width / 2,
